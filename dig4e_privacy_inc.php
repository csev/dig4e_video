<?php
// Set before include: $DIG4E_LEGAL_MODULE, $DIG4E_LEGAL_URL, $DIG4E_LEGAL_SHORT
if ( ! isset($DIG4E_LEGAL_MODULE, $DIG4E_LEGAL_URL, $DIG4E_LEGAL_SHORT) ) {
    die('Privacy configuration missing.');
}
...
<p>
This policy describes how Digitization for Everybody (Dig4E) collects, uses, and protects personal
information when you use our teaching and learning sites, including
<a href="https://www.dig4e.com/">www.dig4e.com</a> and this
<a href="<?= htmlspecialchars($DIG4E_LEGAL_URL) ?>"><?= htmlspecialchars($DIG4E_LEGAL_SHORT) ?></a>
<?= htmlspecialchars($DIG4E_LEGAL_MODULE) ?> module site.
Dig4E provides open course materials, autograded activities, and related tools for learners
...
<p>
We use Google Accounts as our login system on this site. When you sign in with Google, we receive
your name, email address, and profile image from Google as permitted by your Google account settings.
We do not receive your Google password. Google's collection and use of your data is governed by
<a href="https://policies.google.com/privacy" target="_blank" rel="noopener noreferrer">Google's Privacy Policy</a>.
</p>
<p><strong>When do we collect information?</strong></p>
<p>
We collect information when you register or log in (including via Google Sign-In), launch tools
from an LMS, complete autograded assignments, participate in discussions, update your profile, or
otherwise use features that require an account or save your progress.
</p>
